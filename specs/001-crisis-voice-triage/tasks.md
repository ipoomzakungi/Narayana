...
- [X] T001 Create FastAPI app skeleton in `app/main.py`
...
- [X] T002 Add backend dependencies and pytest config in `requirements.txt`
...
- [X] T004 Implement typed settings and provider-mode helpers in `app/core/config.py`
...
- [X] T005 [P] Create audio and debug event models in `app/models/audio.py`
...
- [X] T006 [P] Create triage schema models in `app/models/triage.py`
...
- [X] T007 [P] Create crisis case persistence models in `app/models/case.py`
...
- [X] T008 Add unit tests for triage schema validation in `tests/unit/test_triage_schema.py`
...
- [X] T009 [P] [US1] Define provider interface in `app/services/voice_agent_provider.py`
...
- [X] T010 [US1] Implement deterministic mock provider in `app/services/mock_voice_provider.py`
...
- [X] T011 [P] [US1] Add safety rule unit tests in `tests/unit/test_safety_rules.py`
...
- [X] T012 [US1] Implement deterministic safety rules in `app/services/safety_rules.py`
...
- [X] T013 [P] [US1] Add Thai transcript integration test in `tests/integration/test_thai_transcript_to_red_case.py`
...
- [X] T014 [US1] Implement transcript triage endpoint in `app/api/routes_triage.py`
...
- [X] T015 [US1] Add provider fallback tests in `tests/unit/test_provider_fallback.py`
...
- [X] T016 [P] [US1] Define case repository interface in `app/services/case_repository.py`
...
- [X] T017 [US1] Implement local JSON case repository in `app/services/local_case_repository.py`
...
- [X] T018 [P] [US1] Add local repository tests in `tests/unit/test_local_case_repository.py`
...
- [X] T019 [US1] Implement case creation endpoint in `app/api/routes_cases.py`
...
- [X] T020 [P] [US1] Add cases API tests in `tests/integration/test_cases_api.py`
...
- [X] T021 [P] [US1] Create frontend environment and API client in `frontend/lib/triage-api-client.ts`
...
- [X] T022 [US1] Create compact debug console shell in `frontend/app/voice-debug/page.tsx`
...
- [X] T023 [P] [US1] Add frontend debug console component tests in `frontend/tests/voice-debug-console.test.tsx`
...
- [X] T024 [P] [US2] Implement audio frame validation in `app/services/audio_frame_service.py`
...
- [X] T025 [P] [US2] Add VAD state machine tests in `tests/unit/test_vad_service.py`
...
- [X] T026 [US2] Implement energy-based VAD in `app/services/vad_service.py`
...
- [X] T027 [US2] Implement turn manager in `app/services/turn_manager.py`
...
- [X] T028 [US2] Implement local audio WebSocket route in `app/api/routes_audio.py`
...
- [X] T029 [P] [US2] Add mock local mic integration test in `tests/integration/test_mock_local_mic_flow.py`
...
- [X] T030 [US2] Add browser microphone capture client in `frontend/lib/audio-client.ts`
...
- [X] T031 [US2] Add live VAD state and debug timeline UI in `frontend/components/voice/VoiceDebugConsole.tsx`
...
- [X] T032 [P] [US1] Implement Azure health endpoint in `app/api/routes_audio.py`
...
- [X] T033 [US1] Implement Azure Speech STT provider in `app/services/azure_speech_provider.py`
...
- [X] T034 [US1] Implement Azure OpenAI structured triage provider in `app/services/azure_openai_triage_provider.py`
...
- [X] T035 [US1] Wire AzureSpeechOpenAIProvider selection in `app/services/voice_agent_provider.py`
...
- [X] T036 [US1] Add manual Azure Speech Thai audio test notes in `README.md`
  - Files: `README.md`
...
- [X] T037 [P] [US1] Implement Cosmos case repository in `app/services/cosmos_case_repository.py`
...
- [X] T038 [US1] Add repository selection in `app/services/case_repository.py`
...
- [X] T039 [US1] Implement optional Azure Voice Live provider in `app/services/azure_voice_live_provider.py`
...
- [X] T040 [US1] Add Voice Live provider selection guard in `app/services/voice_agent_provider.py`
  - Files: `app/services/voice_agent_provider.py`, `app/core/config.py`
...
- [X] T041 [P] [US4] Define audio input adapter protocols in `app/services/audio_frame_service.py`
  - Files: `app/services/audio_frame_service.py`
...
- [X] T042 [US4] Add Twilio and ACS adapter placeholders in `app/services/audio_frame_service.py`
...
- [X] T043 [P] [US4] Add adapter interface documentation in `README.md`
  - Files: `README.md`
...
- [X] T044 Add README local setup, mock demo, and Azure setup in `README.md`
  - Files: `README.md`
...
- [X] T045 [P] Add end-to-end smoke test script in `tests/integration/test_gateway_demo_smoke.py`
...
- [X] T046 Run full backend test suite and record result in `specs/001-crisis-voice-triage/tasks.md`
...
- [X] T047 Run frontend test/build checks and record result in `specs/001-crisis-voice-triage/tasks.md`
  - Files: `specs/001-crisis-voice-triage/tasks.md`
...
- 2026-05-02: `pytest` passed with 43 tests.
- 2026-05-02: `npm test` passed in `frontend` with 5 tests.
- 2026-05-02: `npm run build` passed in `frontend`.
- Manual Azure Speech Thai audio, Cosmos DB write/read, and Azure Voice Live smoke tests are documented in `README.md` and skipped until credentials/resources are available.
